...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<section>\n    <div v-show=\"visible\" class=\"alert alert-{{ type }}\" transition=\"fade\">\n        <strong>{{ message }}</strong>\n        <button type=\"button\" class=\"btn btn-default btn-update\" @click=\"updateRows\">Actualizar registros</button>\n    </div>\n\n</section>\n"
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1cfe8a87", module.exports)
  } else {
    hotAPI.update("_v-1cfe8a87", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    data: function data() {
        ...
        /**
         *
         * Todas las variables que son 'props' ya no se necesitan definir en el data.
         *
         */
        return {
    ...
    methods: {
        getData: function getData(page_url) {
            ...
            paginationurl = page_url || this.current_url;

            this.$http.get(paginationurl).then(function (successResponse) {

                //console.log(successResponse);

                _this.$set('pagination', successResponse.data.meta.pagination);

                _this.$set('pagination_list', successResponse.data.data);
        ...
        resetAlert: function resetAlert() {
            ...
            this.alert.new_users = 0;
            this.message_update = '';
        },
        suscribePusher: function suscribePusher() {
            var _this2 = this;

            this.pusher = new _pusherJs2.default('ae40f50c690583e5aeab');

            this.pusherChannel = this.pusher.subscribe('laravue-channel');

            this.pusherChannel.bind('laravue.user.register', function (data) {

                _this2.alert.new_users++;
                _this2.alert.message = _this2.message_update;
                _this2.alert.visible = true;
                /*
                                    this.$nextTick(() => {
                
                                        console.log("Callback que se ejecuta cuando la data y el DOM cambio.");
                                    });
                */
            });
        },
        getPage: function getPage(page) {
            ...
            this.config.page_init = page;

            this.generateURL();
        },
        getPageByLimit: function getPageByLimit() {

            this.config.current_limit; /* Ya esta enlazado */

            lastpage = Math.ceil(this.pagination.total / this.config.current_limit);

            if (this.config.page_init >= lastpage) {

                this.config.page_init = lastpage;
            }
        ...
        getSearch: function getSearch() {
            ...
            this.config.search; /* Ya esta enlazado */

            this.config.page_init = 1;

            this.generateURL();
        },
        changeOrder: function changeOrder(orderBy) {

            if (this.config.order_by == orderBy) {

                this.config.order_mode = this.config.order_mode == 'ASC' ? 'DESC' : 'ASC';
            } else {

                this.config.order_by = orderBy;

                this.config.order_mode = 'ASC';
            }

            this.generateURL();
        },
        activeOrder: function activeOrder(order, mode) {

            return this.config.order_by == order && this.config.order_mode == mode;
        },
        generateURL: function generateURL() {

            paginationurl = this.current_url;

            paginationurl = paginationurl.replace(/(limit=)[^\&]+/, '$1' + this.config.current_limit);

            paginationurl = this.importReplacementURL(paginationurl, 'search', this.config.search);

            paginationurl = this.importReplacementURL(paginationurl, 'page', this.config.page_init);

            paginationurl = this.importReplacementURL(paginationurl, 'order', this.config.order_by);

            paginationurl = this.importReplacementURL(paginationurl, 'mode', this.config.order_mode);

            this.getData(paginationurl);
        },
        importReplacementURL: function importReplacementURL(url, parameter, value) {
            ...
            if (match === null) {
                ...
                newURL = url + delimiter + parameter + "=" + value;
            } else {

                delimiter = match[0].charAt(0);

                newURL = url.replace(regex, delimiter + parameter + "=" + value);
            }
    ...
    computed: {
        ...
        current_url: function current_url() {
             ...
             * https://gist.github.com/stinoga/8101816
             *
             */

            currenturl = this.pagination_url + '?limit=' + this.config.current_limit + '&search=' + this.config.search + '&order' + this.config.order_by + '&mode' + this.config.order_mode + '&page=' + this.config.page_init;

            if (this.pagination.total_pages > 1) {

                currenturl = this.pagination.links.previous || this.pagination.links.next;

                currenturl = currenturl.replace(/(&page=)[^\&]+/, '$1' + this.pagination.current_page);
            }

            return currenturl;
        },

        message_update: function message_update() {

            return this.alert.new_users > 1 ? "Se han registrado " + this.alert.new_users + " nuevos usuarios." : "Se ha registrado un nuevo usuario.";
        }
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<section v-show=\"loadingComponent\" transition=\"fade\">\n\n    <div class=\"panel panel-default\">\n        <div class=\"panel-heading\">\n            <h3 class=\"panel-title\">Reporte de usuarios</h3>\n            <div class=\"panel-counter\">\n                <span>\n                    Total: <strong>{{ pagination.total }} Usuarios.</strong>\n                </span>\n            </div>\n        </div>\n        <div class=\"panel-body\">\n\n            <alert :message=\"alert.message\" :visible.sync=\"alert.visible\"></alert>\n\n            <section class=\"form-horizontal\">\n                <div class=\"form-group\">\n                    <div class=\"col-sm-3\">\n                        <div class=\"input-group\">\n                            <span class=\"input-group-addon\">\n                                <i class=\"fa fa-list-ol\"></i>\n                            </span>\n                            <select class=\"form-control\" v-model=\"config.current_limit\" @change=\"getPageByLimit\">\n                                <option v-for=\"i in config.limits\" v-bind:value=\"i\">\n                                    {{ i }}\n                                </option>\n                            </select>\n                        </div>\n                    </div>\n                    <div class=\"col-sm-9\">\n                        <form class=\"input-group\" @submit.prevent=\"getSearch\">\n                            <span class=\"input-group-addon\">\n                                <i class=\"fa fa-search\"></i>\n                            </span>\n                            <input type=\"text\" v-model=\"config.search\" class=\"form-control\" placeholder=\"Buscar usuario...\">\n                            <span class=\"input-group-btn\">\n                                <button class=\"btn btn-primary\" type=\"submit\">\n                                    <i v-show=\"config.loading\" class=\"fa fa-spinner fa-pulse fa-fw\"></i>\n                                    Buscar Usuario\n                                </button>\n                            </span>\n                        </form>\n                    </div>\n                </div>\n            </section>\n\n            <section v-show=\"this.pagination.total > 0\">\n                <table class=\"table table-bordered table-hover table-striped table-center\">\n                    <thead class=\"head-filters\">\n                        <tr>\n                            <th>#</th>\n                            <th>Foto de Perfil</th>\n                            <th @click.stop=\"changeOrder('name')\">\n                                Nombres\n                                <span>\n                                    <i v-show=\"activeOrder('name', 'ASC')\" class=\"fa fa-sort-alpha-asc\"></i>\n                                    <i v-show=\"activeOrder('name', 'DESC')\" class=\"fa fa-sort-alpha-desc\"></i>\n                                </span>\n                            </th>\n                            <th @click.stop=\"changeOrder('email')\">\n                                Correo Electrónico\n                                <span>\n                                    <i v-show=\"activeOrder('email', 'ASC')\" class=\"fa fa-sort-alpha-asc\"></i>\n                                    <i v-show=\"activeOrder('email', 'DESC')\" class=\"fa fa-sort-alpha-desc\"></i>\n                                </span>\n                            </th>\n                        </tr>\n                    </thead>\n                    <tbody>\n                        <tr v-for=\"item in pagination_list\">\n                            <td>\n                                {{ (pagination.current_page * pagination.per_page - pagination.per_page) + ($index + 1) }}\n                            </td>\n                            <td>\n                                <img :src=\"item.image\" width=\"24px\">\n                            </td>\n                            <td>\n                                {{ item.name | capitalize }}\n                            </td>\n                            <td>\n                                {{ item.email }}\n                            </td>\n                        </tr>\n                    </tbody>\n                </table>\n                <div v-show=\"this.pagination.total_pages > 1\">\n                    <div class=\"row\">\n                        <div class=\"col-xs-4 col-sm-4 col-md-4 col-lg-4\">\n                            <button type=\"button\" class=\"btn btn-primary btn-block\" v-on:click=\"getData(pagination.links.previous)\" :disabled=\"!pagination.links.previous\">\n                                <i class=\"fa fa-angle-double-left\"></i>\n                            </button>\n                        </div>\n                        <div class=\"col-xs-4 col-sm-4 col-md-4 col-lg-4\">\n                            <button type=\"button\" class=\"btn btn-default btn-block\" disabled=\"disabled\">\n                                <i v-show=\"config.loading\" class=\"fa fa-spinner fa-pulse fa-fw\"></i>\n                                Página {{ pagination.current_page }} de {{ pagination.total_pages }}\n                            </button>\n                        </div>\n                        <div class=\"col-xs-4 col-sm-4 col-md-4 col-lg-4\">\n                            <button type=\"button\" class=\"btn btn-primary btn-block\" v-on:click=\"getData(pagination.links.next)\" :disabled=\"!pagination.links.next\">\n                                <i class=\"fa fa-angle-double-right\"></i>\n                            </button>\n                        </div>\n                    </div>\n                    <div class=\"text-center\">\n                        <ul class=\"pagination\">\n                            <li v-bind:class=\"{ 'disabled' : pagination.current_page <= 1 }\">\n                                <span v-if=\"pagination.current_page <= 1\">\n                                    <i class=\"fa fa-angle-double-left\"></i>\n                                </span>\n                                <a v-else=\"\" v-on:click.prevent=\"getPage(pagination.current_page - 1)\">\n                                    <i class=\"fa fa-angle-double-left\"></i>\n                                </a>\n                            </li>\n                            <li v-for=\"i in pagination.total_pages\" v-bind:class=\"{ 'active' : pagination.current_page == (i+1) }\">\n                                <span v-if=\"pagination.current_page == (i+1)\">\n                                    {{ pagination.current_page }}\n                                </span>\n                                <a v-else=\"\" v-on:click.prevent=\"getPage(i + 1)\">\n                                    {{ i + 1 }}\n                                </a>\n                            </li>\n                            <li v-bind:class=\"{ 'disabled' : pagination.current_page >= pagination.total_pages }\">\n                                <span v-if=\"pagination.current_page >= pagination.total_pages\">\n                                    <i class=\"fa fa-angle-double-right\"></i>\n                                </span>\n                                <a v-else=\"\" v-on:click.prevent=\"getPage(pagination.current_page + 1)\">\n                                    <i class=\"fa fa-angle-double-right\"></i>\n                                </a>\n                            </li>\n                        </ul>\n                    </div>\n                </div>\n            </section>\n\n            <section v-show=\"this.pagination.total == 0\">\n                <div class=\"alert alert-warning\">\n                    <strong>No hay registros que coincidan con la busqueda</strong>\n                </div>\n            </section>\n\n            <!--\n                <section>\n                    <pre>\n                        {{ $data | json }}\n                    </pre>\n                </section>\n            -->\n        </div>\n    </div>\n</section>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-212e147f", module.exports)
  } else {
    hotAPI.update("_v-212e147f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./Alert.vue":8,"pusher-js":3,"vue":6,"vue-hot-reload-api":4,"vueify/lib/insert-css":7}],10:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n")
'use strict';
...
exports.default = {
    ...
    data: function data() {
        ...
        return {
            message: 'Welcome to Vueify'
        };
    },
    methods: function methods() {}
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<section>\n    <div class=\"panel panel-default\">\n        <div class=\"panel-heading\">\n            <h3 class=\"panel-title\">Componentes VueJS</h3>\n        </div>\n        <div class=\"panel-body\">\n            {{ message }}\n        </div>\n    </div>\n</section>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1bcc772f", module.exports)
  } else {
    hotAPI.update("_v-1bcc772f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-39f58666", module.exports)
  } else {
    hotAPI.update("_v-39f58666", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _Topheader = require('./Topheader.vue');
...
new _vue2.default({
  el: '#App',
  components: {
    Topheader: _Topheader2.default, Pagination: _Pagination2.default, Panel: _Panel2.default
  },
  data: {
    pagination_url: 'users-paginate',
    list: []
  }
});

},{"./Pagination.vue":9,"./Panel.vue":10,"./Topheader.vue":11,"jquery":1,"vue":6,"vue-resource":5}]},{},[12]);
